...
export default class ReactNativeRootToast extends Component {
  state = {
  ...
  getApiCode = () => (
    ...
    {
        position:`}{' '}
      <Text style={styles.value}>{this.state.position}</Text>
      {`,
        delay:`}{' '}
      <Text style={styles.value}>{this.state.delay}</Text>
      {`,
        shadow:`}{' '}
      <Text style={styles.value}>{this.state.shadow.toString()}</Text>
      {`,
        animation:`}{' '}
      <Text style={styles.value}>{this.state.animation.toString()}</Text>
      {`,
        hideOnPress:`}{' '}
      <Text style={styles.value}>{this.state.hideOnPress.toString()}</Text>
      {`,
        backgroundColor:`}{' '}
      <Text style={styles.value}>{this.state.backgroundColor.toString()}</Text>
      {`,
        shadowColor:`}{' '}
      <Text style={styles.value}>{this.state.shadowColor.toString()}</Text>
      {`,
        textColor:`}{' '}
      <Text style={styles.value}>{this.state.textColor.toString()}</Text>
      {`
    }
);`}
    </Text>
