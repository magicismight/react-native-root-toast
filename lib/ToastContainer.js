...
class ToastContainer extends Component {
    ...
    _dimensionsChangeSub;
    _keyboardDidChangeFrameSub;

    componentDidMount = () => {
        _dimensionsChangeSub = Dimensions.addEventListener('change', this._windowChanged);
        if (this.props.keyboardAvoiding) {
            _keyboardDidChangeFrameSub = Keyboard.addListener(
    ...
    componentWillUnmount = () => {
        this._hide();
        _dimensionsChangeSub?.remove();
        _keyboardDidChangeFrameSub?.remove();
    };
