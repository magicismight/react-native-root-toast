...
class ToastContainer extends Component {
    ...
    onLayout(nativeEvent){
      this.setState({window_width: nativeEvent.layout.width});
    }
    ...
    render() {
        ...
        return (this.state.visible || this._animating) ? <View
            ...
            onLayout={(event) => this.onLayout(event.nativeEvent)}
        >
            <TouchableWithoutFeedback
            ...
            >
                <Animated.View
                    style={[
                        ...
                        {
                          marginHorizontal: this.state.window_width * ((1 - TOAST_MAX_WIDTH) / 2)
                        },
